"""
Django settings for dappstore project.
...
SECRET_KEY = '!a=1vt-q3eck0#16(i@tvbq*t4ne1e$styj)+gz7hpz8ttymh-'
...
WSGI_APPLICATION = 'dappstore.wsgi.application'
...
CONTRACT_ADDRESS=Web3.toChecksumAddress('0x326008fFD5C0B86F96eb07989aE6C73586B32B95')
